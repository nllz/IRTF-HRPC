...
Discussion of Universal Declaration of Human Rights and Internet Architecture
--------------------------------------------------------------------
...
+   The protocol's effects on human rights on the Internet.
+   The protocol's effect  on human rights in combination with other protocols
+   The effect of specific protocol elements, seperately or in combination with other protocl elements on human rights on the Internet
+   The ability to determine when various effects are occuring
+   The effect of deployment or non deployment.  While this may be may seem beyond the protocl itself, often the design of protocol, its difficulty in implementation and the degree to which it contain poison pills or other protocol artifacts that discourse implementation or deployment can be signifant in the over human rights affect of a protocol.
...
Currently defined in detaiil in draft-varon-hrpc-methodolgy to be folded in at appropriate time

Briefly methodolgy has included:
+ scoping the research problem
+ determining terminology to be use linking engineering and human rights concepts
+ establoshing methology
...
In each of the case studies, the behavior of the protocols is anlysed for its postive and negative effects.  In some case these effects are due to the design of the protocol itself, in others they are due to existing or absent features.
...
The case studies point to several areas of protocol behavior that may be apprpriate for considerations:  

+ Charcter encoding for internationalization 
- DNS Record
  - Distortion
  - Injection
  - Removal
...
- Traffic
  ...
  - Throttling
- User Identification
  - Source and Destination visibilty
  - Tracking
