 ...
 * RFC Editor should consider the elimination of offensive terminology an important act of correcting larger editorial issues and clarifying technical concepts. (maybe rather suggesting alternative language?)
 * Suggest to authors that even when referencing other specifications that have not replaced offensive terminology with an alternative that the author makes a note that the term is original and not being suggested by the author.
 * That the offensive term "master/slave" be replaced with the more accurate alternative (see section number).
 * That the offensive term "white/blacklist" be replaced with the more accurate alternative (see section number).
